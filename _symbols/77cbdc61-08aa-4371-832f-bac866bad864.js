// Featured Quote - Updated July 16, 2025
function noop() { }
function run(fn) {
    return fn();
}
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*quote*/ 4 && raw_value !== (raw_value = /*quote*/ ctx[2].html + "")) div1.innerHTML = raw_value;			if (dirty & /*name*/ 1) set_data(t2, /*name*/ ctx[0]);
